      ...
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg p-10">
        ...
        <section className="mb-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            DodunSoftSolutions is committed to protecting your personal information and your right to privacy. This Privacy Policy explains what information we collect, how we use it, and what rights you have in relation to it. This policy applies to all information collected through our website, <a href="https://www.dodunsoftsolutions.com/" className="text-blue-500 underline">https://www.dodunsoftsolutions.com/</a>.
          </p>
        </section>
